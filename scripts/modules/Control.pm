...
sub basic_5_season {
	...
	my @control = 
		...
		"$heat_W 0 $cool_W 0 $heat_T_low 100 0 # heat_max_W heat_min_W cool_max_W cool_min_W heat_setpoint_C cool_setpoint_C relative_humidity?",
		'#CTL_TYPE ctl type, law (basic control), start @ hr',
		'0 1 6',
		'#NUM_DATA_ITEMS Number of data items',
		'7',
		'#DATA_LINE1 space seperated',
		"$heat_W 0 $cool_W 0 $heat_T_high 100 0 # heat_max_W heat_min_W cool_max_W cool_min_W heat_setpoint_C cool_setpoint_C relative_humidity?",
		'#CTL_TYPE ctl type, law (basic control), start @ hr',
		'0 1 9',
		'#NUM_DATA_ITEMS Number of data items',
		'7',
		...
		'7',
		'#DATA_LINE1 space seperated',
		"$heat_W 0 $cool_W 0 $heat_T_low $cool_T_low 0 # heat_max_W heat_min_W cool_max_W cool_min_W heat_setpoint_C cool_setpoint_C relative_humidity?",
		'#CTL_TYPE ctl type, law (basic control), start @ hr',
		'0 1 6',
		'#NUM_DATA_ITEMS Number of data items',
		'7',
		'#DATA_LINE1 space seperated',
		"$heat_W 0 $cool_W 0 $heat_T_high $cool_T_low 0 # heat_max_W heat_min_W cool_max_W cool_min_W heat_setpoint_C cool_setpoint_C relative_humidity?",
		'#CTL_TYPE ctl type, law (basic control), start @ hr',
		'0 1 9',
		'#NUM_DATA_ITEMS Number of data items',
		'7',
		'#DATA_LINE1 space seperated',
		"$heat_W 0 $cool_W 0 $heat_T_low $cool_T_high 0 # heat_max_W heat_min_W cool_max_W cool_min_W heat_setpoint_C cool_setpoint_C relative_humidity?",
		'#CTL_TYPE ctl type, law (basic control), start @ hr',
		'0 1 15',
		'#NUM_DATA_ITEMS Number of data items',
		'7',
		...
		'7',
		'#DATA_LINE1 space seperated',
		"$heat_W 0 $cool_W 0 0 $cool_T_low 0 # heat_max_W heat_min_W cool_max_W cool_min_W heat_setpoint_C cool_setpoint_C relative_humidity?",
		'#CTL_TYPE ctl type, law (basic control), start @ hr',
		'0 1 6',
		'#NUM_DATA_ITEMS Number of data items',
		'7',
		...
		'7',
		'#DATA_LINE1 space seperated',
		"$heat_W 0 $cool_W 0 0 $cool_T_high 0 # heat_max_W heat_min_W cool_max_W cool_min_W heat_setpoint_C cool_setpoint_C relative_humidity?",
		'#CTL_TYPE ctl type, law (basic control), start @ hr',
		'0 1 15',
		'#NUM_DATA_ITEMS Number of data items',
		'7',
