...
# 		#-----------------------------------------------
		...
		# Operations files
		#-----------------------------------------------
		& simple_replace ($hse_file->[$record_extensions->{"main.opr"}], "#DATE", 1, 1, "*date $time");	#set the time/date for the main.opr file
		...
		if ($record_indc->{"bsmt"}) {
			& simple_replace ($hse_file->[$record_extensions->{"bsmt.opr"}], "#DATE", 1, 1, "*date $time");	#set time/date 
			...
			& simple_replace ($hse_file->[$record_extensions->{"crwl.opr"}], "#DATE", 1, 1, "*date $time");
			my $crwl_ach;
		...
		if ($record_indc->{"attc"}) {
			& simple_replace ($hse_file->[$record_extensions->{"attc.opr"}], "#DATE", 1, 1, "*date $time");
