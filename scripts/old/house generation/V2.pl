...
sub main () {
	...
	& template_gen ();		#generate the arrays corresponding to each line of the templates
	...
	while (<CSDDRD_DATA>) {
		...
		my @hse_file;			#house file templatesfor use of with this record
		& hse_file_intialize ();	#Initialize output file arrays for the present house record based on the templates
...
#--------------------------------------------------------------------
# Subroutines within the main code to ease the passing of variables
#--------------------------------------------------------------------

	sub template () {	#Open and read the template files
