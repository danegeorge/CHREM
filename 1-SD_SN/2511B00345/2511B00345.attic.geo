...
# then additional vertices for windows/doors
 ...
 11.82   0.00   4.88 # base v2; total v2
 11.82  17.64   4.88 # base v3; total v3
  0.00  17.64   4.88 # base v4; total v4
  5.86   0.00   7.34 # top v1; total v5
  5.96   0.00   7.34 # top v2; total v6
  5.96  17.64   7.34 # top v3; total v7
  5.86  17.64   7.34 # top v4; total v8
#END_VERTICES
...
# outside condition EXTERIOR, ANOTHER, BASESIMP, ADIABATIC
  ...
  3, front         OPAQ  VERT  A_or_R_gbl   EXTERIOR       
  4, right         OPAQ  SLOP  A_or_R_slop  EXTERIOR       
  5, back          OPAQ  VERT  A_or_R_gbl   EXTERIOR       
  6, left          OPAQ  SLOP  A_or_R_slop  EXTERIOR       
