...
# then additional vertices for windows/doors
  0.00   0.00  -1.83 # base v1
  7.78   0.00  -1.83 # base v2
  7.78   7.78  -1.83 # base v3
  0.00   7.78  -1.83 # base v4
  0.00   0.00   0.00 # top v5
  7.78   0.00   0.00 # top v6
  7.78   7.78   0.00 # top v7
  0.00   7.78   0.00 # top v8
#END_VERTICES
...
# outside condition EXTERIOR, ANOTHER, BASESIMP, ADIABATIC
  ...
  3, Side-front    OPAQ  VERT  BSMT_wall    BASESIMP       
  4, Side-right    OPAQ  VERT  BSMT_wall    BASESIMP       
  5, Side-back     OPAQ  VERT  BSMT_wall    BASESIMP       
  6, Side-left     OPAQ  VERT  BSMT_wall    BASESIMP       
