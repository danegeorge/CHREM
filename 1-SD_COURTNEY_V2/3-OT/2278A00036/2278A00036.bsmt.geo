...
# then additional vertices for windows/doors
 ...
 11.24   0.00   0.00 # base v2; total v2
 11.24  11.24   0.00 # base v3; total v3
  0.00  11.24   0.00 # base v4; total v4
  0.00   0.00   2.44 # top v1; total v5
 11.24   0.00   2.44 # top v2; total v6
 11.24  11.24   2.44 # top v3; total v7
  0.00  11.24   2.44 # top v4; total v8
#END_VERTICES
...
# outside condition EXTERIOR, ANOTHER, BASESIMP, ADIABATIC
  ...
  5, back          OPAQ  VERT  B_wall_cc    BASESIMP       
  6, left          OPAQ  VERT  B_wall_cc    BASESIMP       
