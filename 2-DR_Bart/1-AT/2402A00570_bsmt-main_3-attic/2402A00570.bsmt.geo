...
# then additional vertices for windows/doors
  ...
  5.65   0.00   0.00 # base v2; total v2
  5.65   7.80   0.00 # base v3; total v3
  0.00   7.80   0.00 # base v4; total v4
  0.00   0.00   2.06 # top v1; total v5
  5.65   0.00   2.06 # top v2; total v6
  5.65   7.80   2.06 # top v3; total v7
  0.00   7.80   2.06 # top v4; total v8
#END_VERTICES
