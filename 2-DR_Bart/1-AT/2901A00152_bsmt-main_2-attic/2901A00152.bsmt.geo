...
# then additional vertices for windows/doors
  ...
  7.42   0.00   0.00 # base v2; total v2
  7.42   7.97   0.00 # base v3; total v3
  0.00   7.97   0.00 # base v4; total v4
  0.00   0.00   2.21 # top v1; total v5
  7.42   0.00   2.21 # top v2; total v6
  7.42   7.97   2.21 # top v3; total v7
  0.00   7.97   2.21 # top v4; total v8
#END_VERTICES
