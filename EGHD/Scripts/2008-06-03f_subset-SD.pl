...
$desired_houses=15000;	#3590;								#THE DESIRED NUMBER OF HOUSES TO REMAIN IN THE SELECTED DATASET
...
open(OUTPUT_FINAL,">2007-10-31_EGHD-HOT2XP_dupl-chk_A-files_region_qual_pref-SD_subset-SD-freq.csv")||die("can't open datafile:$!");
...
sub MAIN_CODE{			#MAIN CODE THAT THE THREAD JUMP TO
	...
	$house_type1=1;		#1 IS SINGLE DETACHED, 2 IS ROW (END), 3 IS ROW (MIDDLE)
	$house_type2=1;		#OPTIONAL SECOND TYPE (e.g. set #1=2 and #2=3 for all "row" type)
	$house_type3=1;		#OPTIONAL THIRD TYPE (e.g. set each equal to a type for all houses)
	...
	open(CALCULATION0,">2007-10-31_EGHD-HOT2XP_dupl-chk_A-files_region_qual_pref-SD_subset-SD-param-#$file.csv")||die("can't open datafile:$!");
	open($TOTALS[0],">2007-10-31_EGHD-HOT2XP_dupl-chk_A-files_region_qual_pref-SD_subset-SD-freq-#$file.csv")||die("can't open datafile:$!");
	open(OUTPUT_ALL,">2007-10-31_EGHD-HOT2XP_dupl-chk_A-files_region_qual_pref-SD_subset-SD-#$file.csv")||die("can't open datafile:$!");
	...
	for ($z=0;$z<=$#data;$z++){
		open($OUTPUT[$z],">2007-10-31_EGHD-HOT2XP_dupl-chk_A-files_region_qual_pref-SD_subset-SD-100-columns-#$file-file-#$z.csv")||die("can't open datafile:$!")
